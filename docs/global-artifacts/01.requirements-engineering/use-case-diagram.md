...
| **1004** | [_`As Customer Manager, I want to edit a job opening`_](../../sprintc/us_1004/readme.md) |
...
| **1010** | [_`As Customer Manager, I want to open or close phases of the process for a job opening`_](../../sprintc/us_1010/readme.md) |
...
| **1013** | [_`As Customer Manager, I want to rank the candidates for a job opening`_](../../sprintc/us_1013/readme.md) |
| **1014** | [_`As Customer Manager, I want to record the time and date for an interview with a candidate`_](../../sprintc/us_1014/readme.md) |
| **1015** | [_`As Customer Manager, I want to execute the process of verification of requirements of applications for a job opening`_](../../sprintc/us_1015/readme.md) |
| **1016** | [_`As Customer Manager, I want the system to notify candidates, by email, of the result of the verification process`_](../../sprintc/us_1016/readme.md) |
| **1017** | [_`As Customer Manager, I want to upload a text file with the candidate responses for an interview`_](../../sprintc/us_1017/readme.md) |
| **1018** | [_`As Customer Manager, I want to execute the process that evaluates (grades) the interviews for a job opening`_](../../sprintc/us_1018/readme.md) |
| **1019** | [_`As Customer Manager, I want to get an ordered list of candidates, using the job interview points (grades), to help me analyze the candidates`_](../../sprintc/us_1019/readme.md) |
| **1020** | [_`As Customer Manager, I want to publish the results of the selection of candidates for a job opening, so that candidates and customer are notified by email of the result`_](../../sprintc/us_1020/readme.md) |
| **1021** | [_`As Customer Manager, I want to display all the data of an application`_](../../sprintc/us_1021/readme.md) |
| **2000a** | [_`As Operator, I want to register a candidate and create a corresponding user`_](../../sprintb/us_2000a/readme.md) |
| **2000b** | [_`As Operator, I want to enable/disable a candidate`_](../../sprintc/us_2000b/readme.md) |
...
| **2001b** | [_`As Product Owner, I want the system to, continuously, process the files produced by the Applications Email Bot, so that they can be imported into the system by initiative of the Operator`_](../../sprintc/us_2001b/readme.md) |
