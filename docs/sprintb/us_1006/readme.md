...
- `Description:` As Customer Manager, I want to display all the personal data of a candidate.

- `Sprint:` This US makes part of the intermediary stage of development of the integrative project of this semester, Sprint B.

- `Objectives:` The team must make sure that the system can display all the personal details of any given candidate.
