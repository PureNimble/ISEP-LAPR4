...
- `Description:` As Customer Manager, I want to record the time and date for an interview with a candidate.

- `Sprint:` This US makes part of the final stage of development of the integrative project of this semester, Sprint C.

- `Objectives:` The team must make sure that the system supports the recording of the time and date for an interview with a candidate.
