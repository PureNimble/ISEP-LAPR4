...
# 1201804 - Rafael Araújo - Sprint B - Self Assessment
...
**Justification and Evidences:** The engineering process was correctly followed, with all the necessary artifacts being produced and correctly documented. The justification of the process followed/applied is very good, and the application of good practices and techniques is exemplary.
...
**Justification and Evidences:** There is evidence of a team decision-making process in which students actively participate and which results in the assignment of tasks in a clear and timely manner. There is evidence of group tasks such as integration and deployment activities.
...
**Justification and Evidences:** The integration between most components/functionalities was correct, without any type of incoherence and/or unnecessary coupling.
