...
# 1221694 - João Pinto - Sprint A - Self Assessment
...
**Justification and Evidences:** We managed to follow the engineering process correctly and the code and design are completely aligned. We also applied good practices and techniques in an exemplary way.
...
**Justification and Evidences:** We have managed to use the repository in a very good way, with good messages and a good connection to issues/tasks.
...
**Justification and Evidences:** We managed to work weekly and assign tasks in a clear and timely manner, but we could have done better with communication and task assignment.
...
**Justification and Evidences:** We managed to deploy the system in a local virtual environment and demonstrate it without any execution failures.
...
**Justification and Evidences:** We have a good integration between most components/functionalities without any type of incoherence and/or unnecessary coupling.
...
**Justification and Evidences:** All requirements have been met in full, and any options related to the interpretation/analysis of the problem are correctly justified and are evidence of our understanding of the problem domain.
