...
# 1221694 - João Pinto - Sprint C - Self Assessment
...
**Justification and Evidences:** The engineering process was correctly followed, with all the necessary documentation and justification. The code and design are completely aligned, and the application of good practices and techniques is exemplary.
...
**Justification and Evidences:** The use of the repository was exemplary, with significant messages and no failures in connection to issues/tasks. The task/issue management boards were used in an exemplary way.
...
**Justification and Evidences:** The team decision-making process was exemplary, with students actively participating and resulting in the assignment of tasks in a clear and timely manner. There was evidence of group tasks such as integration and deployment activities.
...
**Justification and Evidences:** The integration between most components/functionalities was correct, without any type of incoherence and/or unnecessary coupling. The integration was perfectly documented.
