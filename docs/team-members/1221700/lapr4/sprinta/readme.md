...
# 1221700 - Vasco Sousa - Sprint A - Self Assessment
...
**Justification and Evidences:** The team gave it´s best and in my opinion we did some solid work.
...
**Justification and Evidences:** The team used the repository in a very good way, with good messages and good connection to issues/tasks.
...
**Justification and Evidences:** I think we did a good job in the team work, but we could have done better with communication and task assignment.
...
**Justification and Evidences**:** We can deploy the system in a local virtual environment and demonstrate it without any execution failures.
