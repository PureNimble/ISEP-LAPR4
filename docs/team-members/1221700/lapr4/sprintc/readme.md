...
# 1221700 - Vasco Sousa - Sprint C - Self Assessment
...
**Justification and Evidences:** The engineering process was correctly followed, with all the necessary artefacts being produced and correctly documented. The code and design are completely aligned, and the application of good practices and techniques is exemplary.
...
**Justification and Evidences:** The repository was used frequently, with messages that were mostly significant and always connected to issues/tasks. The task/issue management boards were used in an exemplary way.
...
**Justification and Evidences:** There is evidence of a team decision-making process in which students actively participate and which results in the assignment of tasks in a clear and timely manner. There is also evidence of group tasks such as integration and deployment activities.
...
**Justification and Evidences:** The system runs outside the IDE, distributed across two or more remote virtual environments (machines or containers) (e.g. in the cloud). The group was able to demonstrate the system without any execution failures during the demonstration. The correct version was used.
...
**Justification and Evidences:** The integration between most components/functionalities is correct, without any type of incoherence and/or unnecessary coupling. The integration is also perfectly documented.
...
**Justification and Evidences:** All requirements have been met in full, and any options related to the interpretation/analysis of the problem are correctly justified and are evidence of your understanding of the problem domain. There is a very complete definition of acceptance criteria, with most criteria reflected in tests.
