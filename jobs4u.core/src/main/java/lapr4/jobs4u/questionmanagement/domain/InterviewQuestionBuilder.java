...
public class InterviewQuestionBuilder implements DomainFactory<InterviewQuestion> {
    ...
    public InterviewQuestionBuilder with(final QuestionType type, final String cotation, final String cotationType,
            final String body, final List<InterviewAnswer> possibleAnswers,
    ...
    public InterviewQuestionBuilder withImporterPlugin(final QuestionImporterPlugin importerPlugin) {
    ...
    public InterviewQuestion build() {
        final InterviewQuestion question = new InterviewQuestion(this.type, this.cotation, this.cotationType, this.body,
                this.possibleAnswers, this.importerPlugin);
        if (LOGGER.isInfoEnabled()) {
            LOGGER.info("Registering new question [{}] {} {} {} {} {} {}", question, this.type, this.cotation,
                    this.cotationType, this.body, this.possibleAnswers, this.importerPlugin);
        }
        return question;
    }
}
